...
const CACHE_VERSION = 'inko-2.6.0-f7a697';
...
const STATIC_ASSETS = [
    ...
    '/assets/js/api.js',
    '/assets/js/appairage.js',
    '/assets/js/bibliotheque.js',
    '/assets/js/card-hover.js',
    '/assets/js/cartes-gestes.js',
    ...
    '/assets/js/eula.js',
    '/assets/js/feuille.js',
    '/assets/js/global.js',
    '/assets/js/hero3d.js',
    '/assets/js/i18n.js',
    '/assets/js/import.js',
    '/assets/js/lecteur-curseur.js',
    '/assets/js/lecteur-gestes.js',
    ...
    '/assets/js/telecommande.js',
    '/assets/js/theme.js',
    '/assets/js/tirer-rafraichir.js',
    '/assets/js/u.js',
    '/assets/js/une-main.js',
